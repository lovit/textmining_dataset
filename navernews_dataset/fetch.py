...
def _fetch(url, download_fname, directory):
    ...
    download_path = os.path.abspath('{}/navernews_dataset/{}'.format(installpath, download_fname))
    ...
    unzip_path = os.path.abspath('{}/navernews_dataset/{}'.format(installpath, directory))
